...
extern "C" {
    #include "../../../../multi_contact_point_estimator/uneven_terrain_stand/src/libqhull_r/user_r.h"
}
#include <iostream>
#include "../../../../multi_contact_point_estimator/uneven_terrain_stand/src/qhulltest/RoadTest.h" // QT_VERSION

#include "libqhullcpp/RoadError.h"
extern "C" {
    #include "../../../../multi_contact_point_estimator/uneven_terrain_stand/src/libqhull_r/qhull_ra.h"
}
