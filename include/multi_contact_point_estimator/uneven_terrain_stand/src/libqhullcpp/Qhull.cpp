...
** $Id: //main/2015/qhull/src/Qhull.cpp#3 $$Change: 2066 $
...
#include "../../../../multi_contact_point_estimator/uneven_terrain_stand/src/libqhullcpp/QhullFacet.h"
#include "../../../../multi_contact_point_estimator/uneven_terrain_stand/src/libqhullcpp/QhullFacetList.h"
#include "../../../../multi_contact_point_estimator/uneven_terrain_stand/src/libqhullcpp/QhullQh.h"
#include "../../../../multi_contact_point_estimator/uneven_terrain_stand/src/libqhullcpp/RboxPoints.h"
...
// added by me the next two
void Qhull::runQhull3D(const std::vector<vec3> &points, const char* args)
{
    m_externalPoints = new PointCoordinates(3, "no comment");  //3 = dimension
    vector<double> allPoints;

    /*for each (vec3 p in points) { // needs STL LIBS
